                    ...
                    <table class="table-hover table-bordered">
                        ...
                        <tbody>
                            ...
                            <img class="img-thumbnail" src="./public/uploads/<?= $libro['rutaImg']; ?>"width="200" height="300" alt="La portada del Libro esta dañada">
                                ...
                                <td><a href="<?=base_url('borrar/'.$libro['id_libro'])?>" class="btn btn-danger" type="button">Eliminar</a></td>
                                <td><a href="<?=base_url('actualizar/'.$libro['id_libro'])?>" class="btn btn-info" type="button">Editar</a></td>
                                </tbody>
                            <?php } ?>
