        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="post" action="<?= base_url('/editar') ?>" enctype="multipart/form-data">
                    ...
                    <br>
                    <label for="imagen" class="form-control">Portada Actual : <br> <br><img src="../public/uploads/<?= $libros['rutaImg']; ?>" width="300" alt="Card image cap"></label>
                    <br><br>
                    ...
                    <br> <br>
                    <button type="submit" class="btn btn-primary">Actualizar</button> <a href="<?= base_url('eliminar') ?>" class="btn btn-info" type="button">Eliminar Libro</a>
                </form>
                </p>
            </div>
        </div>
